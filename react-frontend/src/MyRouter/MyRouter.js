...
import SingleIncomesPage from "../components/app_components/IncomesPage/SingleIncomesPage";
import IncomeProjectLayoutPage from "../components/app_components/IncomesPage/IncomeProjectLayoutPage";
import SingleExpensesPage from "../components/app_components/ExpensesPage/SingleExpensesPage";
import ExpenseProjectLayoutPage from "../components/app_components/ExpensesPage/ExpenseProjectLayoutPage";
import SingleSavingsGoalPage from "../components/app_components/SavingsGoalPage/SingleSavingsGoalPage";
import SavingsGoalProjectLayoutPage from "../components/app_components/SavingsGoalPage/SavingsGoalProjectLayoutPage";
import SingleDebtsPage from "../components/app_components/DebtsPage/SingleDebtsPage";
import DebtProjectLayoutPage from "../components/app_components/DebtsPage/DebtProjectLayoutPage";
import SingleAlertsPage from "../components/app_components/AlertsPage/SingleAlertsPage";
import AlertProjectLayoutPage from "../components/app_components/AlertsPage/AlertProjectLayoutPage";
//  ~cb-add-import~
    ...
    return (
        <Routes>
            ...
            <Route path="/project" exact element={<DashboardAdminControl />} />
                ...
                // myapp
<Route path="/incomes/:singleIncomesId" exact element={<SingleIncomesPage />} />
<Route path="/incomes" exact element={<IncomeProjectLayoutPage />} />
<Route path="/expenses/:singleExpensesId" exact element={<SingleExpensesPage />} />
<Route path="/expenses" exact element={<ExpenseProjectLayoutPage />} />
<Route path="/savingsGoal/:singleSavingsGoalId" exact element={<SingleSavingsGoalPage />} />
<Route path="/savingsGoal" exact element={<SavingsGoalProjectLayoutPage />} />
<Route path="/debts/:singleDebtsId" exact element={<SingleDebtsPage />} />
<Route path="/debts" exact element={<DebtProjectLayoutPage />} />
<Route path="/alerts/:singleAlertsId" exact element={<SingleAlertsPage />} />
<Route path="/alerts" exact element={<AlertProjectLayoutPage />} />
