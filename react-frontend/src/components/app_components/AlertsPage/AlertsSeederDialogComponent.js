...
import seederData from "./alerts.seeder.json";
...
const AlertsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AlertsSeederDialogComponent);
