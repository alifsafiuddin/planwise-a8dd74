    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Alerts",
          type: "error",
          message: error.message || "Failed get Alerts",
        });
      });
