...
import seederData from "./savingsGoal.seeder.json";
...
const SavingsGoalSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(SavingsGoalSeederDialogComponent);
