...
const SavingsGoalPage = (props) => {
    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "SavingsGoal",
          type: "error",
          message: error.message || "Failed get SavingsGoal",
        });
      });
  ...
  const deleteAll = async () => {
    ...
    const promises = data.map((e) =>
      client.service("savingsGoal").remove(e._id),
    );
    await Promise.all(
      promises.map((p) =>
        p.catch((error) => {
