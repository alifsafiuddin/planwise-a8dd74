    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Incomes",
          type: "error",
          message: error.message || "Failed get Incomes",
        });
      });
