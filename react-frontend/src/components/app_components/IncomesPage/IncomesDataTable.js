...
const IncomesDataTable = ({
  ...
  const p_dateTemplate3 = (rowData, { rowIndex }) => (
    <p>{new Date(rowData.dateReceived).toLocaleDateString()}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Source"
          body={pTemplate1}
          filter={selectedFilterFields.includes("source")}
          hidden={selectedHideFields?.includes("source")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("dateReceived")}
          hidden={selectedHideFields?.includes("dateReceived")}
          sortable
          style={{ minWidth: "8rem" }}
        />
