...
import seederData from "./incomes.seeder.json";
...
const IncomesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomesSeederDialogComponent);
