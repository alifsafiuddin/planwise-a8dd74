...
import seederData from "./expenses.seeder.json";
...
const ExpensesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ExpensesSeederDialogComponent);
