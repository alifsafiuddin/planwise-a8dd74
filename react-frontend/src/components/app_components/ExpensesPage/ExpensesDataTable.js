...
const ExpensesDataTable = ({
  ...
  const p_dateTemplate3 = (rowData, { rowIndex }) => (
    <p>{new Date(rowData.dateSpent).toLocaleDateString()}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          filter={selectedFilterFields.includes("dateSpent")}
          hidden={selectedHideFields?.includes("dateSpent")}
          sortable
          style={{ minWidth: "8rem" }}
        />
