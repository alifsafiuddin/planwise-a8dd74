...
const DebtsDataTable = ({
  ...
  const p_numberTemplate3 = (rowData, { rowIndex }) => (
    <p>{rowData.interestRate}</p>
  );
  const p_dateTemplate4 = (rowData, { rowIndex }) => (
    <p>{new Date(rowData.dueDate).toLocaleDateString()}</p>
  );
    ...
    <>
      ...
      >
        ...
        <Column
          ...
          header="Debt Name"
          body={pTemplate1}
          filter={selectedFilterFields.includes("debtName")}
          hidden={selectedHideFields?.includes("debtName")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("amountDue")}
          hidden={selectedHideFields?.includes("amountDue")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
          ...
          filter={selectedFilterFields.includes("interestRate")}
          hidden={selectedHideFields?.includes("interestRate")}
          sortable
          style={{ minWidth: "8rem" }}
        />
        <Column
