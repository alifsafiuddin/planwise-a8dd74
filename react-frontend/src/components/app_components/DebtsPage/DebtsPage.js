    ...
    client
      ...
      .catch((error) => {
        ...
        props.alert({
          title: "Debts",
          type: "error",
          message: error.message || "Failed get Debts",
        });
      });
