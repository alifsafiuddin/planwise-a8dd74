...
import seederData from "./aiFinancialAdvice.seeder.json";
...
const AiFinancialAdviceSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(AiFinancialAdviceSeederDialogComponent);
